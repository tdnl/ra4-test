// Taken directly from node_modules/ra-ui-material-ui/dist/cjs/button/SaveButton.js
"use strict";
var __assign =
  (this && this.__assign) ||
  function () {
...
var SaveButton = function (props) {
  ...
  var _g = (0, react_hook_form_1.useFormState)(),
      ...
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (
                !(saveContext === null || saveContext === void 0
                  ? void 0
                  : saveContext.save)
              )
                return [3 /*break*/, 2];
              return [
                ...
                saveContext.save(
                  values,
                  __assign(__assign({}, mutationOptions), {
                    transform: transform,
                  })
                ),
              ];
  ...
  return React.createElement(
    ...
    isSubmitting
      ? React.createElement(material_1.CircularProgress, {
